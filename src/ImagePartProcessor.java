            ...
            for(int y=yStart;y<yLength;y+=Settings.getCharImageSize()){
                try{
                    ...
                    if(settings.isUseColor()){
                        ...
                        boolean
                                hasRoomLeft = x>=Settings.getCharImageSize(),
                                hasRoomRight=x<xLength+Settings.getCharImageSize(),
                                hasRoomTop=y>=Settings.getCharImageSize(),
                                hasRoomBottom=y<yLength+Settings.getCharImageSize();
                        int blockX = x,
                                blockY = y,
